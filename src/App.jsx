    ...
    <>
      ...
      >
        <div className="images">
          <img id="Immersive" src="/Immersive.png" alt="Immersive Project"/>
          <img id="Visionary" src="/Visionary.png" alt="Visionary Project" />
          <img id="Dynamic" src="/Dynamic.png" alt="Dynamic Project" />
          <img id="Seamless" src="/Seamless.png" alt="Seamless Project" />
          <img id="Minimal" src="/Minimal.png" alt="Minimal Project" />
          <img id="Precision" src="/Precision.png" alt="Precision Project" />
          <img id="Dominant" src="/Dominant.png" alt="Dominant Project" />
        </div>
        ...
        <section id="section-1">
          <nav>
            ...
            <div className="nav-elem">
              <i className="ri-arrow-right-s-line"></i> Welcome !
            </div>
            <div className="nav-elem">
          ...
          <div className="middle">
            <div className="left">
              <h1>
                CRAFTED<br /> WITH <br /> PURPOSE <br /> AND <br /> PASSION
        ...
        <section id="section-2">
          <div className="titles">
            <div img-title="Immersive" className="title">
              <small> # 1 </small>
              <h1>Immersive</h1>
            </div>
            <div img-title="Visionary" className="title">
              <small> # 2 </small>
              <h1> Visionary</h1>
            </div>
            <div img-title="Dynamic" className="title">
              <small> # 3 </small>
              <h1> Dynamic</h1>
            </div>
            <div img-title="Seamless" className="title">
              <small> # 4 </small>
              <h1>Seamless</h1>
            </div>
            <div img-title="Minimal" className="title">
              <small> # 5 </small>
              <h1>Minimal</h1>
            </div>
            <div img-title="Precision" className="title">
              <small> # 6 </small>
              <h1>Precision</h1>
            </div>
            <div img-title="Dominant" className="title">
              <small> # 7 </small>
              <h1>Dominant</h1>
            </div>
          </div>
        ...
        <div id="section-4">
          ...
          <div className="bottom">
            ...
            <div className="right">
              ...
              <p>
                Where creativity meets technology, digital experiences are crafted to be immersive, expressive, and unforgettable. Every detail is meticulously designed, balancing clarity, emotion, and innovation. The result is bold, distinctive, and timeless, with precision and intention at its core. Experiences emerge that are impactful, resonant, and visually striking, leaving a lasting impression beyond the screen.
        ...
        <footer id="section-5">
          ...
          <div className="footr">
            ...
            <div className="devd">
              <div id="tag">
                <a target="_blank" href="https://github.com/alokverma711">
                ...
                <a
                  target="_blank"
                  href="https://www.instagram.com/a1ok_verma/?hl=en"
                >
                  <i className="ri-instagram-line"></i>
                </a>
              </div>
              <div className="av"> © 2026 Alok Verma </div>
            </div>
          </div>
        </footer>
      </main>
